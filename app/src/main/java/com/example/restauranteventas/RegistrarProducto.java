...
public class RegistrarProducto extends AppCompatActivity {
    ...
    private void limpiarCampos() {
        ...
        txtPrecio.setText(""); // Limpiar el campo de texto del precio
        spinnerTipoProducto.setSelection(0); // Restablecer el spinner de tipo de producto a la posición inicial
    }
